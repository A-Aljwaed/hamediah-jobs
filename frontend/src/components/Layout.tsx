          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-8">
              <Link to="/" className="flex items-center gap-2 text-xl font-bold group">
                <div className="w-8 h-8 rounded-xl flex items-center justify-center transition-all duration-300 group-hover:scale-110" style={{background: 'var(--gradient-primary)'}}>
            ...
            <div className="flex items-center gap-4">
              ...
              {isAuthenticated ? (
                <div className="flex items-center gap-3">
                  <div className="hidden sm:flex items-center gap-2 px-4 py-2 bg-primary-50/80 backdrop-blur-sm rounded-xl border border-primary-100">
                    <div className="w-7 h-7 rounded-lg flex items-center justify-center" style={{background: 'linear-gradient(135deg, #10b981 0%, #14b8a6 100%)'}}>
                ...
                <Button asChild className="shadow-md hover:shadow-lg rounded-xl">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <div className="flex gap-3">
                <a href="#" className="w-11 h-11 bg-white border border-gray-200 rounded-xl flex items-center justify-center hover:bg-primary-50 hover:border-primary-300 transition-all duration-200 shadow-sm hover:shadow-md">
                  <svg className="w-5 h-5 text-gray-600 hover:text-primary-600 transition-colors" fill="currentColor" viewBox="0 0 24 24">
