            ...
            <div className="flex items-center gap-8">
              ...
              <div className="hidden md:flex items-center gap-6">
                <Button variant="ghost" asChild>
                  <Link 
                    to="/jobs" 
                    className={`flex items-center gap-2 ${isActivePath('/jobs') ? 'text-primary-600' : 'text-gray-600'}`}
                  >
                ...
                {isAuthenticated && (
                  <Button variant="ghost" asChild>
                    <Link 
                      to="/create-job" 
                      className={`flex items-center gap-2 ${isActivePath('/create-job') ? 'text-primary-600' : 'text-gray-600'}`}
                    >
